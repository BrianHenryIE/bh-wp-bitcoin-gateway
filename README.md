...
[![WordPress tested 7.0](https://img.shields.io/badge/WordPress-v7.0%20tested-0073aa.svg)](https://wordpress.org/plugins/woocommerce-gateway-bitcoin) 
[![PHPCS WPCS](.github/phpcs.svg)](https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards) 
[![PHPUnit ](.github/coverage.svg)](https://brianhenryie.github.io/bh-wp-bitcoin-gateway/) 
[![PHPStan ](.github/phpstan.svg)](https://github.com/szepeviktor/phpstan-wordpress) 
...
* [ ] Get number of `TODO:`s < 100 (currently 187, `grep -rni includes -e "TODO" | wc -l`)

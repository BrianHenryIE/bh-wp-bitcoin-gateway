 ...
 * @phpstan-type BlockStreamApiTransactionArray array{txid:string, version:int, locktime:int, vin:list<BlockStreamApiTransactionVInArray>, vout:list<BlockStreamApiTransactionVOutArray>, size:int, weight:int, fee:int, status:array{confirmed:bool, block_height:int, block_hash:string, block_time:int|null}}
